...
.page-breadcrumb span { color: #3d4f61; }
...
.page-title-accent { color: var(--secondary); }
...
@media(max-width:600px) {
    .page-body { padding: 28px 16px 56px; }
...
.form-control::placeholder { color: #b0b7c0; }
...
.info-card-top-inner { position: relative; z-index: 1; }
.info-card-top-title {
    font-size: 1rem;
    font-weight: 700;
    color: #fff;
...
.map-emoji { font-size: 2.5rem; position: relative; z-index: 1; }
.map-label {
    font-size: 0.78rem;
    font-weight: 600;
