...
if ($stock <= 0)       { $stockCls = 'out';  $stockLbl = 'Out of Stock'; $stockColor = '#ef4444'; }
elseif ($stock <= $reorder) { $stockCls = 'low';  $stockLbl = 'Low Stock';    $stockColor = '#f59e0b'; }
else                   { $stockCls = 'ok';   $stockLbl = 'In Stock';     $stockColor = '#10b981'; }
...
.thumb-egg   { background: linear-gradient(145deg, #fef9ee 0%, #fef0c7 50%, #fde8a4 100%); }
.thumb-chick { background: linear-gradient(145deg, #f0fdf4 0%, #dcfce7 50%, #bbf7d0 100%); }

.img-bg-blur {
    position: absolute; inset: 0;
    font-size: 18rem;
    display: flex; align-items: center; justify-content: center;
    opacity: 0.07; filter: blur(8px);
}
...
.thumb-mini:hover, .thumb-mini.active {
...
.stock-info-label { color: var(--text-muted); }
.stock-info-value { font-weight: 700; color: var(--dark2); }
.stock-divider {
...
.subtotal-label { color: var(--text-muted); font-weight: 500; }
.subtotal-value {
    font-size: 1.1rem;
    font-weight: 800;
    color: var(--primary);
...
.related-thumb-egg   { background: linear-gradient(135deg, #fef9ee, #fdeec8); }
.related-thumb-chick { background: linear-gradient(135deg, #f0fdf4, #bbf7d0); }
    ...
    <div class="product-info-panel">
        ...
        <div class="order-block">
            ...
            <div class="trust-badges">
                <span class="trust-badge">🌿 Farm Fresh</span>
                <span class="trust-badge">🚚 Fast Delivery</span>
                <span class="trust-badge">💯 Quality Guaranteed</span>
                <span class="trust-badge">🔒 Secure Order</span>
            </div>
        </div>
