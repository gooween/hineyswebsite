...
// Purpose: Browse all products with category filter + search
// ============================================================
...
.breadcrumb a { color: #8fa3b3; transition: color var(--transition); }
...
.toolbar-result strong { color: var(--dark2); }
...
.toolbar-result-tag button {
    ...
    color: var(--primary); font-size: 0.8rem; padding: 0; line-height: 1;
}
...
.products-grid.list-view .product-thumb-emoji { font-size: 2.5rem; }
.products-grid.list-view .product-body { padding: 14px 16px; }
.products-grid.list-view .product-desc { -webkit-line-clamp: 1; }
.products-grid.list-view .product-actions { margin-top: auto; }
...
.empty-state-title {
    font-size: 1.1rem; font-weight: 700; color: var(--dark2); margin-bottom: 8px;
}
.empty-state-sub { font-size: 0.88rem; margin-bottom: 24px; }
.btn-reset {
            ...
            <div class="toolbar-result">
                ...
                <?php if ($categoryId): ?>
                    ...
                    while ($cc = $categories->fetch_assoc()) {
                        if ((int)$cc['id'] === $categoryId) { $catNameDisplay = $cc['name']; break; }
                    }
                    ?>
                    <span class="toolbar-result-tag">
