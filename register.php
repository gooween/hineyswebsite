...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if ($stmt->execute()) {
            $stmt->close();
            header('Location: index.php?msg=registered'); exit;
        } else {
...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .panel-headline em { font-style: italic; color: var(--amber-lt); }
        ...
        .form-desc a { color: var(--amber); font-weight: 600; text-decoration: none; }
        .form-desc a:hover { text-decoration: underline; }
        ...
        .input-icon svg { width: 15px; height: 15px; stroke: currentColor; fill: none; }
        ...
        .input.is-error { border-color: var(--danger); background: #fff8f8; }
        ...
        .pw-toggle svg { width: 15px; height: 15px; stroke: currentColor; fill: none; }
        ...
        .terms a { color: var(--amber); font-weight: 600; text-decoration: none; }
        ...
        .divider span { font-size: 0.74rem; color: #c4b5a5; font-weight: 500; }
        ...
        .login-link a { color: var(--amber); font-weight: 700; text-decoration: none; }
        ...
        @media (max-width: 960px) {
            ...
            .panel { display: none; }
            .form-side { padding: 36px 24px; box-shadow: none; }
        }
            ...
            <form method="POST" action="register.php" id="regForm" onsubmit="handleSubmit(event)">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        <span class="input-icon"><svg viewBox="0 0 24 24" stroke-width="1.8"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg></span>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <div class="input-wrap">
                            <span class="input-icon"><svg viewBox="0 0 24 24" stroke-width="1.8"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg></span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrap">
                            <span class="input-icon"><svg viewBox="0 0 24 24" stroke-width="1.8"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 13 19.79 19.79 0 0 1 1.61 4.37 2 2 0 0 1 3.6 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 9.91a16 16 0 0 0 6.09 6.09l.95-.95a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg></span>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap textarea-wrap">
                        <span class="input-icon"><svg viewBox="0 0 24 24" stroke-width="1.8"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg></span>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        <span class="input-icon"><svg viewBox="0 0 24 24" stroke-width="1.8"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg></span>
...
function checkStrength(val) {
    ...
    const levels = [
        { pct: '20%', bg: '#dc2626', label: 'Very weak',   color: '#dc2626' },
        { pct: '40%', bg: '#d97706', label: 'Weak',        color: '#d97706' },
        { pct: '60%', bg: '#f59e0b', label: 'Fair',        color: '#b45309' },
        { pct: '80%', bg: '#16a34a', label: 'Strong',      color: '#15803d' },
        { pct: '100%',bg: '#047857', label: 'Very strong', color: '#065f46' },
    ];
...
function handleSubmit(e) {
    const pw1 = document.getElementById('password').value;
    const pw2 = document.getElementById('confirm_password').value;
    if (pw1 !== pw2) { e.preventDefault(); checkMatch(); return; }
