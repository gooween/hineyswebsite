...
if (isset($_GET['logout'])) {
    session_unset();
    session_destroy();
    header('Location: index.php?msg=loggedout'); exit;
}
...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .pw-toggle svg { width: 17px; height: 17px; stroke: currentColor; fill: none; }
        ...
        @media (max-width: 900px) {
            ...
            .panel { display: none; }
            .form-side { padding: 40px 28px; box-shadow: none; }
        }
    ...
    <div class="panel">
        ...
        <div class="panel-top">
            ...
            <div class="panel-pills">
                <div class="pill"><div class="pill-dot"></div> Farm Fresh Daily</div>
                <div class="pill"><div class="pill-dot"></div> Fast Local Delivery</div>
                <div class="pill"><div class="pill-dot"></div> No Preservatives</div>
                <div class="pill"><div class="pill-dot"></div> Quality Guaranteed</div>
            </div>
        </div>
